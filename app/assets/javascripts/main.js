...
$('#ct').click(function(){ $('html,body').animate({scrollTop:$('#price').offset().top}, 800); return false; }); 
//代表一個完整的執行區塊
$('#dt').click(function(){ $('html,body').animate({scrollTop:$('#contact').offset().top}, 800); return false; }); 
//代表一個完整的執行區塊
